...
info_IPS = pd.read_csv(main_path+'/static/BD_IPS_prueba.csv', encoding='latin-1')
idx_usr = 3000 #Index for username
#Obtener departamentos
...
#    temppass = nit[-4:]
    ...
    #idx_usr = idx_usr+1
    username = 'saludcol_prueba'+str(idx_ips)
...
tabla.to_csv('Passwords_prueba.csv',index=False)
